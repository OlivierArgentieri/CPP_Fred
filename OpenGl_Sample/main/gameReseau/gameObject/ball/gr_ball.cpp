...
gr_ball::gr_ball(glm::vec3 _position, glm::vec3 _rotation, glm::vec3 _scale,
	const char* _texturePath, const char* _vertexShaderPAth, const char* _fragmentShaderPath, gr_color _color) : gr_objGameObject(PATH_TO_OBJ, _position, _rotation, _scale, _texturePath, _vertexShaderPAth, _fragmentShaderPath, _color)
{
